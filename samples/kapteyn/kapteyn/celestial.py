...
:class:`skyrefsys`. It is used to initialize variables
...
The string is converted to a tuple by :func:`parseskydef`.

The parser is used in function :func:`skymatrix`
and :func:`sky2sky`. External applications can use this function
...
#----------------------------------------------------------------------
   ...
   print("sky2sky((eq, fk5), gal, (0,0,1.0), (10,20,20)) = ")   
   M = sky2sky( (eq, fk5), gal,
                (0,0,1.0), (10,20,20) )

   print(M)
   print("Output should be equal to:")
   print( """matrix([[ 102.6262244 ,  -50.83256452],
        [ 106.78021643,  -41.25289649],
        [ 107.9914125 ,  -41.49143448]])""")

   print("\nSkymatrix test")
   print( "m = skymatrix( (eq,'b1950',fk4), gal)[0]") 
   m = skymatrix((eq,'b1950',fk4), gal)[0]
   print("print(numpy.array2string(numpy.array(m), precision=12))")
   print(n.array2string(n.array(m), precision=12))
   print("\nshould give:")
...
print(tran1(world_eq)-tran2(world_eq))"""
   print(s)
   print("Should give 0,0")
   world_eq = n.array([192.25, 27.4])               # FK4 coordinates of galactic pole
   tran1 = wcs.Transformation("equatorial fk4_no_e B1950.0", "galactic")
   tran2 = wcs.Transformation((wcs.equatorial, wcs.fk4_no_e, 'B1950.0'), wcs.galactic)
   print(tran1(world_eq)-tran2(world_eq))
