...
public class NovatelDataSourceConnector extends Thread
{
    ...
    private NovatelOEM3DataSource novatelDataSourcea;
...
//    private String novatelLogHistory = "";
    ...
    public NovatelDataSourceConnector(NovatelOEM3DataSource novatelDataSourcea, String host,int port, int comport, String commandList)
    {
