 ...
 */
public class @MACRO.PREFIX@DatabaseManager extends GsacDatabaseManager {
    ...
    */
    ...
    public static final String DB_PROPERTIES =
        "/@MACRO.SRCDIR@/resources/gsacdb.properties";
     ...
     */
    public @MACRO.PREFIX@DatabaseManager(@MACRO.PREFIX@Repository repository)
            throws Exception {
        super(repository);
    }
    ...
    public static void main(String[] args) throws Exception {
        @MACRO.PREFIX@DatabaseManager dbm = new @MACRO.PREFIX@DatabaseManager(null);
        dbm.init();
