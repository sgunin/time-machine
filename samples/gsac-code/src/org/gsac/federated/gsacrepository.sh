...
java -Xmx512m -jar lib/@JARFILE@ -port 8080
...
#java -Dgsac.db.username=<username> -Dgsac.db.password=<password> -Dgsac.db.jdbcurl=<jdbcurl>  -Xmx512m -jar lib/@JARFILE@ -port 8080
...
#e.g.:
#java -Dgsac.db.username=root -Dgsac.db.password=password -Dgsac.db.jdbcurl=jdbc:mysql://localhost:3306/cddis  -Xmx512m -jar lib/@JARFILE@ -port 8080
