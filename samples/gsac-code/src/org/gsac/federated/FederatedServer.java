 ...
 *
 */
public class FederatedServer extends GsacServer {
     ...
     */
    public FederatedServer(String[] args) throws Throwable {
        super(args);
    }
    ...
    public GsacServlet doMakeServlet(int port, Properties properties)
            throws Exception {
        return new GsacServlet(new FederatedRepository(), port, properties);
    }
    ...
    public static void main(String[] args) throws Throwable {
        try {
            FederatedServer jettyServer = new FederatedServer(args);
        } catch (Exception exc) {
