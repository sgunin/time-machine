 ...
 */
public class PrototypeDatabaseManager extends GsacDatabaseManager {
    ...
    */
    ...
    public static final String DB_PROPERTIES =
        "/org/prototype/gsac/resources/gsacdb.properties";
     ...
     */
    public PrototypeDatabaseManager(PrototypeRepository repository)
            throws Exception {
        super(repository);
    }
    ...
    public static void main(String[] args) throws Exception {
        PrototypeDatabaseManager dbm = new PrototypeDatabaseManager(null);
        dbm.init();
